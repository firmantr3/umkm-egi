...
<!--Less styles -->
   <!-- Other Less css file //different less files has different color scheam
	<link rel="stylesheet/less" type="text/css" href="customer/themes/less/simplex.less">
	<link rel="stylesheet/less" type="text/css" href="customer/themes/less/classified.less">
	<link rel="stylesheet/less" type="text/css" href="customer/themes/less/amelia.less">  MOVE DOWN TO activate
	-->
	<!--<link rel="stylesheet/less" type="text/css" href="customer/themes/less/bootshop.less">
	<script src="customer/themes/js/less.js" type="text/javascript"></script> -->
